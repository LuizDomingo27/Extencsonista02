...
public partial class FrmReport : Form
{
   ...
   private void Btn_Print_Click(object sender, EventArgs e)
   {
      ...
      if (Report.SelecionarOpcaoRelatorio(list, Cbo_Relatorio, Rb_Maior100Relatorio, Rb_menos100Relatorio, Rb_Menos50Relatorio, Rb_TodosRelatorio, Rb_CategoriaRalatorio) == true)
      {
