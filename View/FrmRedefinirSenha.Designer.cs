namespace ControleEstoqueEscolar.View
{
   partial class FrmRedefinirSenha
   {
      ...
      private void InitializeComponent()
      {
         ...
         // Btn_Redefinir
         // 
         Btn_Redefinir.Animated = true;
         Btn_Redefinir.BorderRadius = 5;
         Btn_Redefinir.CustomizableEdges = customizableEdges1;
         ...
         Btn_Redefinir.FillColor = SystemColors.MenuBar;
         Btn_Redefinir.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
         Btn_Redefinir.ForeColor = Color.Black;
         Btn_Redefinir.Location = new Point(52, 305);
         ...
         guna2ControlBox1.Location = new Point(203, 3);
